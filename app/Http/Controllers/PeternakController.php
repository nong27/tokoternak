...
class PeternakController extends Controller
{
    function index()
    {
        ...
        return view('backend.peternak', compact('peternak', 'title'));
    }
    function view($id)
    {
    ...
    function edit($id)
    {
        $peternak = Peternak::find($id);
        $title = 'Detail Peternak';
        return view('backend.peternak_edit', compact('peternak', 'title'));
    }
    function tambah()
    {
        // $peternak = Peternak::find($id);
        $title = 'Tambah Peternak';
        return view('backend.peternak_tambah', compact('title'));
    }
